--
-- THIS SCRIPT IS A CONSOLIDATION OF acid_table_conversions.sql
--
                         ...
                         ,
                           ...
                           CASE
                               WHEN !array_contains(collect_set(concat_ws(":", tbl_param_key, tbl_param_value)),
                                   ...
                                   AND instr(regexp_extract(tbl_location, 'hdfs://([^/]+)(.*)', 2),
                                             '/apps/hive/warehouse') = 1 AND
                                    tbl_serde_slib = "org.apache.hadoop.hive.ql.io.orc.OrcSerde"
                                   THEN "ACIDv2/Migrate from Non-ACID"
                               WHEN !array_contains(collect_set(concat_ws(":", tbl_param_key, tbl_param_value)),
                                                    "transactional:true") AND tbl_type = "MANAGED_TABLE" AND
                                    tbl_serde_slib = "org.apache.hadoop.hive.ql.io.orc.OrcSerde"
